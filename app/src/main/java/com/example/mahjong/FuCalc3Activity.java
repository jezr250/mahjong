...
public class FuCalc3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fu_calc3);
    ...
    public void goToScore320Activity(View view) {
        ...
        if (totalFu == 20) {
            ...
            Intent intent = new Intent(this, Score325Activity.class);
            startActivity(intent);
        } else if (totalFu == 30) {
            Intent intent = new Intent(this, Score330Activity.class);
            startActivity(intent);
        } else if (totalFu == 40) {
            Intent intent = new Intent(this, Score340Activity.class);
            startActivity(intent);
        } else if (totalFu == 50) {
            Intent intent = new Intent(this, Score350Activity.class);
            startActivity(intent);
        } else if (totalFu == 60) {
            Intent intent = new Intent(this, Score360Activity.class);
            startActivity(intent);
        } else if (totalFu > 60) {
